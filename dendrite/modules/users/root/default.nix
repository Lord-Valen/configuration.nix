      ...
      { pkgs, ... }:
      {
        users.users.${username} = {
          ...
          openssh.authorizedKeys.keys = [
            ...
            "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJc+vv8ScciO+GJjCGDfRdTz3E1S7QFr8SdHu5YiyyGw" # Autolycus
            "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIL2Gr3WNWY1BArGXdldnqLkR5Twk972RnvF9qht3vZOo" # Heracles
          ];
          shell = pkgs.nushell;
        };
        imports =
